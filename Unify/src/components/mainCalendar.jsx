...
export const MainCalendar = ({children, baseDate, onButtonClick}) => {
    ...
    for (let i = 0; i < 42; i++){
        ...
        calendarBoxes.push(<Calender_Date_Box key={date} baseMonth={baseDate.getMonth()} displayDate={new Date(dateIndex)} onClick={onButtonClick}>{children}</Calender_Date_Box>) // Button functionality to be added
